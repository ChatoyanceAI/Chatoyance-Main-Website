...
define( "RECIPIENT_NAME", "Chatoyance" );
define("RECIPIENT_EMAIL", "contact@chatoyance.org");
...
if ( $fname && $senderEmail && $message ) {
  ...
  echo "<p class='success'>Thank you for contacting us. We will get back to you as soon as we can!</p>";
}
